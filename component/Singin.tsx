      ...
      <div className='border-l border-slate-400 min-h-85 w- pl-2'>
        ...
        <form className='flex flex-col gap-1'>
            <label htmlFor="name" className='text-slate-400 my-2'>
                Name
                <input type="text" name="name" id="name"  className='bg-slate-200 w-full py-2 px-3 rounded-lg outline-0 focus:ring-2 ring-cyan-400' placeholder='name'/>
            </label>
            <label htmlFor="email" className='text-slate-400 my-2'>
                Email
                <input type="email" name="email" id="email"  className='bg-slate-200 w-full py-2 px-3 rounded-lg outline-0 focus:ring-2 ring-cyan-400' placeholder='email'/>
            </label>
            ...
            {/* button */}
            <button className="py-2 bg-cyan-700 text-white uppercase font-bold rounded-xl hover:bg-cyan-400 transition-all duration-200 mt-3">Sign in</button>
        </form>
